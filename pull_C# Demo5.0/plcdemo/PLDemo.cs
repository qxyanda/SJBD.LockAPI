        ...
        private void btndevcontrol_Click(object sender, EventArgs e)
        {
            ...
            if (operID == 1)
            {
                ...
                if (outputAddrType == 1)
                {
                    ...
                    doorOrAuxoutID = Convert.ToInt32(tb_doorID.Text);
        ...
        private void btndeldata_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (IntPtr.Zero != h)
                {
                    ...
                    //data = "Time_second=484498659\r\nTime_second=484498931";
                    //MessageBox.Show("tablename = "+tablename+"\r\n data=" + data);
...
//        }
        ...
        private void btn_cancel_alarm_Click(object sender, EventArgs e)
        {
            int _door_no = 0;
            if (txtDoorNo.Text.Trim() != "")
            {
                _door_no = int.Parse(txtDoorNo.Text.Trim());
            }
     

            int ret = ControlDevice(h, 2, _door_no, 0, 0, 0, "");
            MessageBox.Show("cancel_alarm="+ret);
        }

        private void button21_Click(object sender, EventArgs e)
        {
            //int h = DeleteDeviceData(h, "transaction", "Pin=0", "");
        ...
        private void cmbdevtable_SelectedIndexChanged(object sender, EventArgs e)
        {
